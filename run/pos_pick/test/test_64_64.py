...
TEST_PATH = './transformed_data/pospick_64/test'
SAVE_TO = './results'
...
test_transforms_second = CustomCompose([CustomCropByTargets(V=V, width=WIDTH),
                                        CustomChangeTargets(),
                                        CustomAddDim(),
                                        CustomToTensor(),
                                        CustomToFloat(),
...
checkpoint = torch.load('../ckpt/ckpt_ConvNet_64_64_(!1819_new)')
model = ConvNet_64_64()
