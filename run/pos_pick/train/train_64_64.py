...
from seispick.pos_pick.models.CNN import ConvNet_64_64
...
RUN_NAME = f'64_64_({RADIUS_MIN}-{RADIUS_MAX})'

PATH = '/home/seleznev.ns/gradwork_ordered/run/pos_pick/transformed_data/pospick_64'
...
train_transforms = CustomCompose([CustomRandCrop(width=64),
...
test_transforms = CustomCompose([CustomRandCrop(width=64),
                                 CustomRandomShiftLine(min_max_radius=(RADIUS_MIN, RADIUS_MAX), p=0.5),
                                 CustomCropByTargets(V=V, width=64),
                                 CustomChangeTargets(),
                                 CustomAddDim(),
...
model = LightWrapper(model=ConvNet_64_64,
                     model_settings=dict(),
                     opt=AdamW,
