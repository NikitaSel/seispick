...
PATH_TO = '/home/seleznev.ns/gradwork_ordered/run/pos_pick/transformed_data/pospick_64/'

# DATA_PATH = '../rawdata/UK213D10571--1018_1274-H.sgy'
# PATH_TO = '../test/transformed_data/pospick_64/'
...
transforms = ComposeDouble([
                            FunctionWrapperDouble(
                                ...
                                window_size=64, settings=None, error_ratio=2),
                            ])

save_data = SaveSeiLines(PATH_TO, data, min_len=64, transforms=transforms)
save_data.save()
